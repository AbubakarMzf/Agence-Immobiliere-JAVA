...
public class Appartement extends Bien {
    ...
    public Appartement(boolean isMeublee, int nbChambre, int numEtage, boolean hasBalcon, int reference, String adresse, float tarifMensuel, float surfaceTotal, boolean enLocation) {
	...
	public String toString() {
		return  "Appartement [isMeublee=" + isMeublee + ", nbChambre=" + nbChambre + ", numEtage=" + numEtage
				+ ", hasBalcon=" + hasBalcon + super.toString() + "]" ;
	}
